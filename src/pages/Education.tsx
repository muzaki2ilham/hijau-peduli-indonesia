      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-xl p-6 shadow-lg">
          <Tabs defaultValue="articles" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-8 bg-white/50">
              ...
              {articles.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {articles.map((article) => (
                    <Card key={article.id} className="overflow-hidden hover:shadow-xl transition-all duration-300 hover:scale-105 bg-white/80 backdrop-blur-sm">
            ...
            <TabsContent value="videos">
              {videos.length === 0 ? (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {videos.map((video) => (
                    <Card key={video.id} className="overflow-hidden hover:shadow-xl transition-all duration-300 hover:scale-105 bg-white/80 backdrop-blur-sm">
              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-lg shadow p-6">
                ...
                <div className="space-y-4">
                  {resources.map((resource) => (
                    <div key={resource.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg hover:bg-green-50/80 transition-colors">
