                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Card className="hover:shadow-md transition-shadow">
                    ...
                    <CardContent>
                      ...
                      <Button variant="outline" size="sm" className="w-full text-green-600 hover:bg-green-50" asChild>
                        <Link to="/services/waste-collection">Ajukan Permohonan</Link>
                      </Button>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="hover:shadow-md transition-shadow">
                    ...
                    <CardContent>
                      ...
                      <Button variant="outline" size="sm" className="w-full text-green-600 hover:bg-green-50" asChild>
                        <Link to="/services/education-request">Ajukan Permohonan</Link>
                      </Button>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="hover:shadow-md transition-shadow">
                    ...
                    <CardContent>
                      ...
                      <Button variant="outline" size="sm" className="w-full text-green-600 hover:bg-green-50" asChild>
                        <Link to="/services/technical-recommendation">Ajukan Permohonan</Link>
                      </Button>
                    </CardContent>
                  </Card>
                </div>
